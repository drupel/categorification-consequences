...
\section{Quantum Cluster Algebras and Quantum Cluster Characters}
  ...
  \begin{theorem}\cite{rupel1,rupel2}
    ...
    \begin{enumeratea}
      ...
      \item 
        For each $\bfe\in\cQ$ and each positive root \sayS{Schur?} $\bfv\in\cQ$, there exists a polynomial $P_{\bfv,\bfe}(q)$ such that for any rigid indecomposable $V\in\rep_\FF(Q,D)$ with isomorphism class $\bfv$, we have $\big|Gr_\bfe(V)\big|=P_{\bfv,\bfe}\big(|\FF|\big)$.
        ...
        \sayS{I do not know how to extend this to cluster monomials without knowing thet cluster expansions are unique.}
    \end{enumeratea}
  \end{theorem}
