...
\section{Deducing the Conjectures}
  ...
  Nonetheless the corollary immediately implies the weaker statements \cite[Conjecture 7.5]{fomin-zelevinsky4} and \cite[Conjecture~2.9]{reading-stella}.
  ...
  \begin{proposition}[{\cite[Conjecture 4.7]{fomin-zelevinsky4} for acyclic initial exchange matrices}]
    In an acyclic cluster algebra with principal coefficients, a seed is uniquely determined by its exchange matrix and $c$-vectors.
  \end{proposition}
  \begin{proof}
    ...
    Following \cite[Section 2.2]{rupel2}, the exchange matrix of a seed is uniquely determined by its associated local tilting representation.
