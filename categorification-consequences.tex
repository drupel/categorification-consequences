...
\section{Deducing the Conjectures}
  ...
  \end{proposition}
  \begin{proof}
    We can probably state this in general since, if there is no acyclic seed the claim is void
  \end{proof}
  
  \sayS{I took out the conjecture on $\bfc$-vector determining the seed because it is taken care of in \cite{NZ12}.} 
