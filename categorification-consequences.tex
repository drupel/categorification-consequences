...
\maketitle
  ...
  \begin{itemize}
    ...
    \item
      \cite[Conj. 7.17]{fomin-zelevinsky4} is immediate from Corollary~\ref{cor:classical cluster characters}, this immediately implies \cite[Conj. 6.11]{fomin-zelevinsky4} using \cite[Prop. 7.16]{fomin-zelevinsky4}.  
    ...
    \item
      \cite[Conj. 3.9]{reading-speyer} (subgraph containing given cluster variable is connected)  should follow from known tilting theory (see \cite[Cor. 3]{caldero-keller2}).
