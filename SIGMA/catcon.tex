...
\ArticleName{Some consequences of categorification}
...
\Address{$^\dag$\footnote{Affiliated also with the California Institute of Technology, Department of Physics Mathematics and Astronomy, Pasadena, CA 91125, USA and with the University of Notre Dame, Department of Mathematics, Notre Dame, IN 46556, USA.}~Pasadena Unified School District, Math Academy, Pasadena, CA 91101, USA} % Address of First Author
\EmailD{\href{mailto:drupel@nd.edu}{drupel@nd.edu}} % E-mail address of First Author
%\URLaddressD{\url{http://www.home.org/~myHome/}} %URL address of First Author

% Address of Second Author
\Address{$^\ddag$\footnote{Previously affiliated with the University of Leicester, School of Mathematics, Leicester, LE1 7RH, UK}~Università degli studi di Roma ``La Sapienza'', Dipartimento di Matematica ``G. Castelnuovo'', P.le Aldo Moro, 5 – 00185 Rome, Italy}
\EmailD{\href{mailto:stella@mat.uniroma1.it}{stella@mat.uniroma1.it}} % E-mail address of Second Author
\URLaddressD{\url{http://www1.mat.uniroma1.it/people/stella/}} %URL address of second Author
...
\label{sec:qca}
  ...
  Several results are scattered throughout the literature; a compendium focusing on the finite type case can be found in \cite{hohlweg-pilaud-stella}.
